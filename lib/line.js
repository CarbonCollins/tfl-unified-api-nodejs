...
const LineMixin = (SuperClass) => { 
  ...
  const Line = class extends SuperClass {
    ...
    getRoutesById(ids, options = {}) {
      return this.sendRequest((options.direction)
        ? `/Line/${this.serialiseArray(ids)}/Route/Sequence/${options.direction}`
        : `/Line/${this.serialiseArray(ids)}/Route`, options, 'GET');
    }
    ...
    getRoutesByMode(modes, options = {}) {
      return this.sendSerialisedArrayRequest('/Line/Mode/', modes, options, 'GET')
    }
    ...
    getRoutesByServiceType(types, options = {}) {
      return this.sendSerialisedArrayRequest('/Line/Route/', types, options, 'GET')
    }
    ...
    getLineStatusById(ids, options = {}) {
      return this.sendRequest((options.dateRange)
        ...
        : `/Line/${this.serialiseArray(ids)}/Status` , options, 'GET');
    }
