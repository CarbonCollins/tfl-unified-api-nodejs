...
const ColorMixin = (SuperClass) => { 
  ...
  const Color = class extends SuperClass {
     ...
     */
    getLineColor(lineId) {
      return (lineId && lineColors[lineId]) ? lineColors[lineId] : null;
    }
    ...
    getLineCMYKColor(lineId) {
      return (lineId && lineColors[lineId]) ? lineColors[lineId].cmyk : null;
    }
    ...
    getLineRGBColor(lineId) {
      return (lineId && lineColors[lineId]) ? lineColors[lineId].rgb : null;
    }
    ...
    getLineHexColor(lineId) {
      return (lineId && lineColors[lineId]) ? lineColors[lineId].hex : null;
    }
  };
  return Color;
};
